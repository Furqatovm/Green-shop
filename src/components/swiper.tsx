    ...
    >
     ...
     <SwiperSlide className='flex! justify-between! items-center! max-md:flex-col!'>
          <div className='w-[45%] flex flex-col gap-2 max-md:w-full'>
            ...
            <span className='text-blog-text-children text-blogText leading-6'>We are an online plant shop offering a wide range of cheap and trendy plants. Use our plants to create an unique Urban Jungle. Order your favorite plants!</span>
            <div className='my-7'>
